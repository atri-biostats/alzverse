...
tbl_summary(
  ...
  by = STUDYID,
  include = c(AGE, SEX, EDUC, RACE, ETHNIC, BMI, STUDYID, APOE, 
    PACCV6, MMSCORE, AMYLCENT),
  type = all_continuous() ~ "continuous2",
  statistic = list(
    all_continuous() ~ "{mean} ({sd})",
    all_categorical() ~ "{n} ({p}%)"
