...
The `alzverse` is an ecosystem of R packages containing data for Alzheimer's research. Documentation can be found at [https://atri-biostats.github.io/alzverse/](https://atri-biostats.github.io/alzverse/). 
...
Then run the following steps to download `alzverse` code, build package locally with merged data, and install `alzverse`:
...
This work is supported by the [Alzheimer's Clinical Trials Consortium (ACTC)](https://www.actcinfo.org/) (NIH NIA U24AG057437).
